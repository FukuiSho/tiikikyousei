 ...
 */
export const getOffsetCoordinates = (post: Post, posts: Post[]): { latitude: number; longitude: number } => {
  // 同じ座標の投稿を見つける
 ...
 */
export const getPostsForLocation = (selectedPost: Post | null, posts: Post[]): Post[] => {
