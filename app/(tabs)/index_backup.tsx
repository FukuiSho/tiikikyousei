    ...
    mapRef.current?.animateToRegion(
      {
        ...
        latitudeDelta: 0.001, // 約100m範囲（超高倍率）
        longitudeDelta: 0.001, // 約100m範囲（超高倍率）
      },
      1000
    );
      ...
      {location ? (
        ...
        >
          ...
          {posts.map((post, index) => {
            const offsetCoordinates = getOffsetCoordinates(post, index);
            return (
              <Marker
                key={post.id}
        ...
        >
          ...
          >
            ...
            <View style={styles.messageListHeader}>
              <Text style={styles.messageListTitle}>投稿詳細</Text>
              <TouchableOpacity onPress={handleCloseMessageList}>
                    ...
                    <View style={styles.replyForm}>
                      ...
                      <View style={styles.replyFormButtons}>
                        ...
                        <TouchableOpacity
                          ...
                          onPress={() =>
                            handleReplySubmit(getCurrentPost()!.id)
                          }
                        >
